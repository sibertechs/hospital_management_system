...
(35, 25, '2024-02-10', NULL, 'Completed', '2024-09-24 14:19:46', 8, 5),
(36, 25, '2024-09-03', NULL, 'Completed', '2024-09-24 14:21:10', 6, 5);
...
(13, 'John Atia', 'Medical Doctor', '1990-01-02 08:00:00', 'Ghana', '0245320125', 'johnatia@gmail.com', '000000', 'uploads/team2.png', 10, '2024-09-24 14:23:16', 0);
...
(2, 'Finance Unit', 'financeunit@gmail.com', '123456');
...
(7, 'Amoxicillin', 36, 12.00, '2024-09-24 14:28:58', 'Antibiotic');
...
(25, 'Kofi Owusu', '0245120331', 'kofuowusu01@gmail.com', '1997-01-03', 872361, '0000-00-00', '2022-02-01', '2025-02-01', 'Ghana', '0123456789', 'team1.jpeg', 0);
...
(2, 'Pharmacy Department ', 'pharmacydepartment10@gmail.com', '123456');
...
(21, '4', 'Diazepam', 'Adults: 2 pills daily, Children: 1 pill daily', '2 weeks', 'Keep out of reach of children and hot temperature', '2024-09-24 14:25:43', NULL, ''),
(22, '25', 'Loratadine', 'Adults: 2 pills daily, Children: 1 pill daily', NULL, NULL, '2024-03-02 08:00:00', 4, '');
...
(6, '2024-01-30', 15.00, 'Credit', 'Take it daily till it finishes', 2, 5.00, 25);
...
CREATE TABLE IF NOT EXISTS `units_messages` (
  ...
  `sender_type` enum('lab','department') DEFAULT 'lab',
  PRIMARY KEY (`id`),
...
INSERT INTO `units_messages` (`id`, `message`, `created_at`, `doctor_id`, `lab_staff_id`, `pharmacist_id`, `finance_staff_id`, `unit`, `staff_id`, `sender_type`) VALUES
(96, '145', '2024-09-22 20:59:48', 0, 3, 0, 0, 'Pharmacy', NULL, 'lab'),
(95, 'Yeah', '2024-09-22 20:33:55', 11, 0, 0, 0, 'Laboratory', 1, 'lab'),
(94, 'hi', '2024-09-22 20:33:08', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(97, 'fjd', '2024-09-22 21:29:22', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(98, 'YOLO', '2024-09-22 21:30:52', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(99, 'You only leave ones', '2024-09-22 21:42:55', 11, 0, 0, 0, 'Laboratory', NULL, ''),
(100, 'Investor', '2024-09-22 21:44:19', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(101, 'Hi', '2024-09-22 21:58:08', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(102, 'Yeah big man', '2024-09-22 21:58:26', 11, 0, 0, 0, 'Laboratory', NULL, ''),
(103, 'Hi', '2024-09-22 21:58:37', 0, 3, 0, 0, 'Doctor', NULL, 'lab'),
(104, 'Yeah big man', '2024-09-22 22:00:26', 11, 0, 0, 0, 'Laboratory', NULL, ''),
(105, 'Hi', '2024-09-22 22:06:05', 0, 3, 0, 0, 'Doctor', NULL, ''),
(106, 'YO', '2024-09-22 22:33:35', 11, 0, 0, 0, 'Finance', NULL, ''),
(107, 'YOLO NIGGA', '2024-09-22 22:34:12', 0, 0, 0, 1, 'Laboratory', NULL, ''),
(108, 'Hi', '2024-09-22 22:34:27', 0, 3, 0, 0, 'Doctor', NULL, ''),
(109, 'YO', '2024-09-22 22:43:22', 11, 0, 0, 0, 'Finance', NULL, ''),
(110, 'YO', '2024-09-22 22:46:09', 11, 0, 0, 0, 'Finance', NULL, ''),
(111, 'YO', '2024-09-22 22:54:53', 11, 0, 0, 0, 'Finance', NULL, ''),
(112, 'ki', '2024-09-22 22:59:15', 11, 0, 0, 0, 'Laboratory', NULL, ''),
(113, 'Hi', '2024-09-22 22:59:53', 0, 3, 0, 0, 'Doctor', NULL, ''),
(114, 'YOLO NIGGA', '2024-09-23 15:46:35', 0, 0, 0, 1, 'Laboratory', NULL, ''),
(115, 'Hi', '2024-09-23 15:46:47', 0, 3, 0, 0, 'Doctor', NULL, ''),
(116, 'Hello Lab Technician', '2024-09-24 14:26:36', 13, 0, 0, 0, 'Laboratory', NULL, ''),
(117, 'Hello Doc good morning', '2024-09-24 14:31:42', 0, 0, 2, 0, 'Doctor', NULL, 'lab');
...
(22, 'Pat Thomas', 'patthomas12@gmail.com', '123456', 'admin', 0, 'uploads/default-profile.png', '', '0245961203', '1993-02-12', 'Ghana');
COMMIT;
